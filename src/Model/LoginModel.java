...
public class LoginModel extends DBConnector{
	...
	public void LoginFunc(Login obj)
	{
		  ...
		  //setting variables from view object
		...
		try {
			...
			if(count ==1)
			{
				JOptionPane.showMessageDialog(null, "Hello "+usernameField.getText()+" Wellcome again");
				obj.frame.dispose();
				if(rdbtnLibrarian.isSelected())
				{
				System.out.println("Logined as librarian");
			...
			{
				JOptionPane.showMessageDialog(null, "duplicated user & pass");
			}
			else 
			{
